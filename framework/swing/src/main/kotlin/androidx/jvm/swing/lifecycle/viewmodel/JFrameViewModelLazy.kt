...
/**
 * ComponentSwingWindow实现了ViewModelStoreOwner接口， 所以可以在Activity中生成viewModel 示例：
 *
 * ```
 *
 * // CreationExtras使用方式
 ...
 * ```
 */
class JFrameViewModelLazy

@MainThread
public inline fun <reified VM : ViewModel> ComponentJFrame.viewModels(
